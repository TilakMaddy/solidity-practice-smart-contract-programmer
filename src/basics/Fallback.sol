...
contract Fallback {
    ...
    event Log1(string indexed funcName, address indexed who, uint indexed cash, bytes data);
    event Log2(string indexed funcName, address indexed who, uint indexed cash);
